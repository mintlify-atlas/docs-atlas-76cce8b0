---
title: "StelarServer — Complete Method Reference"
sidebarTitle: "StelarServer"
description: "Full reference for all StelarServer methods — events, broadcasting, room management, lifecycle, metrics, and runtime config."
---
...
Immediately destroys all active sockets, clears all rooms, removes internal timers and signal handlers, and closes the HTTP and TCP servers. Use `.gracefulShutdown` in options or listen to `SIGTERM` via `.onShutdown()` for a graceful drain instead.
