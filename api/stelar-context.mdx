---
title: "StelarContext — Event Handler Context Reference"
sidebarTitle: "StelarContext"
description: "StelarContext is passed to every event handler in stelar-time-real. Contains client identity, received payload, and all send, room, and metadata methods."
---
...
<ResponseField name="_correlationId" type="string | undefined">
...
<ResponseField name="clientInfo" type="StelarClientInfo">
  ...
  <Expandable title="StelarClientInfo fields">
    <ResponseField name="clientInfo.id" type="string">
      The unique string ID assigned to this client. Same value as `ctx.id`.
    </ResponseField>
    ...
    <ResponseField name="clientInfo.lastPing" type="number">
      Unix timestamp (milliseconds) of the last successful PING/PONG heartbeat exchange. Used internally to detect stale connections.
    </ResponseField>
