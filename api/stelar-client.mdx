---
title: "StelarClient — Complete Method Reference"
sidebarTitle: "StelarClient"
description: "Full reference for all StelarClient methods — connection, sending, rooms, ACK requests, state/metrics, and runtime config."
---
...
| `"host:port"` with `mode: 'tcp'` | Custom binary TCP | `new StelarClient('localhost:3001', { mode: 'tcp' })` |
