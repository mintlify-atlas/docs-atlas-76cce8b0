---
title: "StelarClient Built-In Events and Connection States"
sidebarTitle: "Client Events"
description: "Reference for all five built-in StelarClient lifecycle events, the four-state connection state machine, and the onMessageQueued and onQueueDrained hooks."
---
...
- **Browser WebSocket** — receives `{ code: number, reason: string }` from the native WebSocket close frame per [RFC 6455](https://www.rfc-editor.org/rfc/rfc6455#section-5.5.1).
